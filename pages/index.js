...
export default function Home() {
  const shuffle = {
    items: [
      bibi.items[Math.floor(Math.random() * bibi.items.length)]
    ]
  }
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Browse Bibi Blocksberg Hörspiele auf Spotify" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div>
        <h2>Finde immer das passende Hörspiel von Bibi Blocksberg auf Spotify</h2>
        <input type="text" value={searchFilter} onChange={watchInput} placeholder="Suche ..." />
      </div>
